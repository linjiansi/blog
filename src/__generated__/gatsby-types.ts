...
type pageUsershayashiDocumentswebblogblogsrcpages404Js3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type pageUsershayashiDocumentswebblogblogsrcpages404Js3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };

type pageUsershayashiDocumentswebblogblogsrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type pageUsershayashiDocumentswebblogblogsrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
...
type pageUsershayashiDocumentswebblogblogsrcpagesindexJs2239478271QueryVariables = Exact<{ [key: string]: never; }>;


type pageUsershayashiDocumentswebblogblogsrcpagesindexJs2239478271Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<(
...
type BioQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<{ readonly author: Maybe<Pick<Author, 'name' | 'summary'>>, readonly social: Maybe<Pick<Social, 'twitter'>> }> }> };
